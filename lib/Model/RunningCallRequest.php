...
/**
 * RunningCallRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RunningCallRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RunningCallRequest';
     ...
     * Sets filter
     *
     * @param string $filter A simple string to filter calls list
     *
     * @return $this
     */
